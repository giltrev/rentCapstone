...
<my:layout>
	...
	<form action="AddVendor" method="post">
		...
		Vendor Type:<br />
		<input type="checkbox" name="vendorType" value="General Handy Man">General Handy Man<br>
		<input type="checkbox" name="vendorType" value="Plumbing">Plumbing<br>
		<input type="checkbox" name="vendorType" value="HVAC">HVAC<br>
		<input type="checkbox" name="vendorType" value="Electrician">Electrician<br>
		<input type="checkbox" name="vendorType" value="Landscape">Landscape<br>
		<input type="checkbox" name="vendorType" value="Cleaning">Cleaning<br>
		...
		Payment Method:<br /><input name="paymentType" type="text"  size="40" /><br />
			<h4>Email Address</h4>
			<table>
